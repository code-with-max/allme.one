...
Revision ID: a7ea4520e023
Revises: 59cff083df44
Create Date: 2023-01-18 17:30:31.842876
...
revision = 'a7ea4520e023'
down_revision = '59cff083df44'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    with op.batch_alter_table('about', schema=None) as batch_op:
        batch_op.add_column(sa.Column('link_group', sa.String(length=2), nullable=True))
